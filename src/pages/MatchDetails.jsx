        ...
        <aside className="fp-event-side">
          ...
          <GlassCard>
            ...
            <div className="fp-context-grid">
              ...
              <MatchRow label="Round" value={fixture.round || 'Dato no disponible'} compact />
              <MatchRow label="Etapa" value={fixture.stage || 'Dato no disponible'} compact />
              <MatchRow label="Venue" value={`${fixture.venue || 'Dato no disponible'}${fixture.venueCity ? ` · ${fixture.venueCity}` : ''}`} compact />
              <MatchRow label="Placeholder" value={fixture.placeholder === null ? 'Información no proporcionada por la API' : (fixture.placeholder ? 'Sí' : 'No')} compact />
            </div>
          </GlassCard>
